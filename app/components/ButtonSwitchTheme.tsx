...
import styled from "styled-components";
 ...
 export function ButtonSwitchTheme() {
  ...
  //     className="p-2 rounded bg-pink-200 dark:bg-black dark:text-white cursor-pointer "
  //   >
  //     Toggle
  //   </button>
  // );
  ...
  return(
    ...
    <StyledWrapper>
      <label className="switch" role="switch" aria-checked={isDark} aria-label="Basculer le thème">
        <input          
          id="checkbox"
          type="checkbox"
          checked={isDark}
